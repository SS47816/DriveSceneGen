...
import torch
import logging
from DriveSceneGen.utils.datasets.dataset import DatasetTemplate
from DriveSceneGen.simulation.utils import common_utils
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/arclab/IV2023_first/tool/cfgs/waymo/mtr+100_percent_data.yaml", help='specify the config of dataset')
